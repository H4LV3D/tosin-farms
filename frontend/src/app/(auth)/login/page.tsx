    ...
    <>
      ...
      <CardContent className="pb-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Button
            variant="outline"
            className="h-12 font-semibold text-earth border-stone-200 hover:bg-stone-50 hover:text-earth transition-colors"
          ...
          <Button
            variant="outline"
            className="h-12 font-bold uppercase tracking-widest text-[10px] border-stone-200 hover:bg-stone-50 hover:text-amber-700 transition-all gap-2"
            onClick={handlePasskeySignIn}
          >
            <Fingerprint className="w-5 h-5 text-stone-400 group-hover:text-amber-600" />
            Passkey
          </Button>
        </div>
      </CardContent>
