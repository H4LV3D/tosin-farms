      ...
      <AuthenticatedPageContainer maxWidth="5xl">
        <div className="py-24 px-4 text-center space-y-6 flex flex-col items-center">
          ...
          <p className="text-stone-500 max-w-sm mx-auto font-medium">
            We couldn&apos;t find the order you&apos;re looking for. It might
              ...
              {order.trackingNumber && (
                <div className="mt-8 p-6 rounded-3xl bg-indigo-50/50 border border-indigo-100 flex items-center justify-between">
                  ...
                  <Button
                    size="sm"
                    variant="ghost"
                    className="text-indigo-700 hover:bg-indigo-100 text-[10px] font-black uppercase tracking-widest gap-2"
                  >
                    Track
              ...
              <div className="space-y-6">
                {order.items.map((item) => (
                  <div key={item.id} className="flex gap-6 group">
                    <div className="w-24 h-24 rounded-[2rem] bg-stone-50 overflow-hidden shrink-0 border border-stone-100 shadow-sm transition-transform duration-500 group-hover:rotate-2 relative">
                      <Image
                        src={
                          item.product?.images[0] ||
                          "https://placehold.co/100x100?text=Farm"
                        }
                    ...
                    <div className="flex-1 flex flex-col justify-center min-w-0">
                      <h4 className="font-bold text-[#1c1917] truncate text-lg group-hover:text-amber-700 transition-colors uppercase tracking-tight">
                        {item.product?.name || "Premium Farm Produce"}
                      </h4>
              ...
              <div className="space-y-4 max-w-sm ml-auto">
                <div className="flex justify-between text-stone-500 font-bold uppercase tracking-widest text-[10px]">
                  ...
                  <span className="text-stone-800">
                    ...
                    {(
                      order.totalAmount -
                      (order.totalAmount > 5000 ? 2500 : 1500)
                    ).toLocaleString()}
                  </span>
                </div>
            ...
            <CardContent className="p-8 space-y-6 relative z-10">
              ...
              <div className="space-y-2">
                ...
                <p className="text-stone-400 text-sm leading-relaxed font-medium">
                  Something wrong with your order? Our farm support team is here
                  to assist you 24/7.
                </p>
              </div>
