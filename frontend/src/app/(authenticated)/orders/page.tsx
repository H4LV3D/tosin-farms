                    ...
                    {["ALL", "PENDING", "PAID", "SHIPPED", "DELIVERED", "CANCELLED"].map((s) => (
                        <button
                            ...
                            className={cn(
                                ...
                                filter === s ? "bg-amber-700 text-white shadow-lg shadow-amber-900/20" : "text-stone-400 hover:text-stone-600 hover:bg-stone-50"
                            )}
                        >
                            {s}
                        </button>
                                            ...
                                            <div className="flex-1 p-6 md:p-8 space-y-6">
                                                ...
                                                <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 pt-6 border-t border-stone-50">
                                                    <div className="space-y-1">
                                                        ...
                                                        <p className="text-lg font-black text-amber-700">₦{order.totalAmount.toLocaleString()}</p>
                                                    </div>
                                                    <div className="space-y-1">
                                                        <p className="text-[10px] font-bold text-stone-400 uppercase tracking-widest">Items</p>
                                                        <p className="text-lg font-black text-stone-800">{order.items.length}</p>
                                                    </div>
