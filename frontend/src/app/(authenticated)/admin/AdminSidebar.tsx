        ...
        <aside className="w-64 min-h-screen bg-[#1a1a0e] text-stone-200 flex flex-col shrink-0 shadow-xl">
            ...
            <div className="px-6 py-7 border-b border-white/10">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="font-bold text-white text-base leading-tight">Tosi Farms</p>
                        <p className="text-[11px] text-amber-400 font-medium tracking-widest uppercase">Admin Panel</p>
                    </div>
                </div>
            </div>
            ...
            <div className="px-4 py-5 border-t border-white/10 space-y-3">
                <div className="px-3 py-2.5 rounded-xl bg-white/5">
                    <p className="text-[10px] text-stone-500 uppercase tracking-widest font-bold">Signed in as</p>
                    <p className="text-xs text-stone-300 mt-0.5 truncate font-medium">{userEmail}</p>
                </div>
                <button
