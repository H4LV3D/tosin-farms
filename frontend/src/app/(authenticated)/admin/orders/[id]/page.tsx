            ...
            <table className="w-full text-sm">
                    ...
                    <td className="px-6 py-3.5">
                      <div className="flex items-center gap-3">
                        {item.product?.images?.[0] ? (
                          <div className="w-10 h-10 rounded-lg overflow-hidden relative bg-stone-100 shrink-0">
                            <Image
              ...
              <tfoot>
                <tr className="border-t border-stone-100 bg-stone-50/60">
                  <td
                    colSpan={3}
                    className="px-6 py-3.5 text-xs font-bold uppercase tracking-widest text-stone-400 text-right"
                  >
                    Total
                  </td>
