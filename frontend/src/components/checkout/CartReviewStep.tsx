    ...
    if (items.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center py-20 gap-4">
                ...
                <p className="font-display text-xl text-stone-600">Your cart is empty</p>
                <p className="text-stone-400 text-sm">Add some products to get started.</p>
                <Link href="/shop">
        ...
        <div>
            ...
            <div className="p-5 bg-amber-50/60 border border-amber-100 rounded-2xl mb-6">
                <div className="flex items-center justify-between text-sm mb-2">
                    ...
                    <span className="font-bold text-[#1c1917]">₦{total.toLocaleString()}</span>
                </div>
