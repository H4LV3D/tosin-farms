    ...
    <section id="difference" className="py-24 lg:py-32 pattern-bg">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div>
            <FadeSlideUp>
              <figure className="relative rounded-2xl overflow-hidden shadow-xl aspect-4/5 ring-1 ring-black/5 group">
                <Image
          ...
          <div>
            ...
            <FadeSlideUp delay={0.1}>
              <h2 className="font-display text-3xl lg:text-4xl font-semibold text-[#1c1917] mb-6 leading-snug">
