...
const testimonials = [
  {
    ...
    quote:
      "The garri from Tosi Farms is the best I\u2019ve tasted \u2014 crunchy, clean, and properly dried. We now buy in bulk for our whole compound.",
  },
  {
    initials: "KO",
    name: "Kunle O.",
    ...
    quote:
      "I buy their maize for my feed mill every season. Always consistent quality and they always have enough in stock. Highly reliable farmers.",
  },
  {
    initials: "NB",
    name: "Ngozi B.",
    role: "Market trader",
    quote:
      "Their pineapples and plantains are always fresh. I stock my market stall from Tosi Farms every week. My customers always ask where I get them!",
  },
];
...
const features = [
  {
    ...
    desc: "We deliver fresh produce and processed goods within our region on scheduled days.",
  },
  {
    colorClass: "text-green-400",
    icon: <div className="font-display text-2xl font-bold">Bulk</div>,
    title: "Bulk Orders Welcome",
    desc: "Whether you need a bag or a truckload — we supply households, traders, schools, and processors.",
  },
  {
    ...
    desc: "Restaurants, canteens, and market traders — contact us for wholesale pricing and regular supply agreements.",
  },
  {
    colorClass: "text-rose-400",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" d="M20 12V22H4V12M22 7H2v5h20V7zM12 22V7M12 7H7.5a2.5 2.5 0 010-5C11 2 12 7 12 7zM12 7h4.5a2.5 2.5 0 000-5C13 2 12 7 12 7z" />
      </svg>
    ),
    title: "Farm Hampers",
    desc: "Gift hampers of our finest garri, dried produce, and seasonal fruits. Perfect for celebrations and occasions.",
  },
];
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <FadeSlideUp delay={0.1}>
              <h2 className="font-display text-3xl lg:text-4xl font-semibold text-[#1c1917]">
          ...
          <StaggerContainer className="grid md:grid-cols-3 gap-8">
            {testimonials.map((t) => (
              <StaggerItem key={t.initials}>
                <div className="bg-white rounded-2xl p-8 shadow-sm border border-stone-100 hover:shadow-md transition-shadow h-full">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-sm text-[#1c1917]">{t.name}</p>
          ...
          <StaggerContainer className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((f) => (
              <StaggerItem key={f.title}>
                <div className="p-7 rounded-2xl bg-white/5 border border-white/10 hover:border-amber-500/30 transition-all hover:-translate-y-1 h-full">
                  <div className={`${f.colorClass} mb-5`}>{f.icon}</div>
      ...
      <section id="order" className="py-24 lg:py-32 pattern-bg">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <FadeSlideUp delay={0.15} className="flex flex-col sm:flex-row items-center justify-center gap-5 mb-16">
            <a
            ...
            >
              ...
              <span className="text-sm font-bold uppercase tracking-widest">Call Us to Order</span>
            </a>
            <a
          ...
          <FadeSlideUp delay={0.25}>
            <div className="bg-white rounded-2xl border border-stone-100 shadow-sm p-8 text-left">
              ...
              <div className="mb-5">
                ...
                <select className="w-full px-4 py-3 h-12 rounded-xl border border-stone-200 bg-stone-50 text-sm focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent transition text-stone-700">
                  ...
                  <option>Fresh Fruits (Mango, Pineapple, Plantain, Pawpaw)</option>
              ...
              <div className="mb-6">
                ...
                <textarea
                  rows={3}
                  placeholder="Tell us what quantity you need and your location&hellip;"
