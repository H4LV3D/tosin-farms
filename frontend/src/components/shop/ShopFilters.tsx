      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
        <div className="relative flex-1 max-w-sm">
          ...
          <Input
            ...
            className="pl-10 h-11 bg-white border-stone-200 focus-visible:ring-amber-500 w-full text-sm"
          />
        </div>
      ...
      <div className="flex overflow-x-auto gap-2.5 pb-2 scrollbar-hide">
        {allCategories.map((cat) => (
          <button
            ...
            className={cn(
              "whitespace-nowrap px-5 py-2 rounded-sm text-[11px] font-bold uppercase tracking-widest transition-all shrink-0",
              activeCategory === cat
